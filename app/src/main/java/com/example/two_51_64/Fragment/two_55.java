...
public class two_55 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_two55, container, false);
    }
    ...
    private void initView() {
        mCar1 = (TextView) getActivity().findViewById(R.id.car1s);
        mCar2 = (TextView) getActivity().findViewById(R.id.car2s);
        mPm25 = (TextView) getActivity().findViewById(R.id.pm25s);
        mTemperature = (TextView) getActivity().findViewById(R.id.temperatures);
        mHumidity = (TextView) getActivity().findViewById(R.id.humiditys);
        mCo2 = (TextView) getActivity().findViewById(R.id.co2s);
    }
}